...
import project.a.project1.exceptions.NonexistentEntityException;
import project.a.project1.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("project.a_project1_jar_0.0.1-SNAPSHOTPU");
